-- Oria v18.3 - corrige ambiguidade da coluna/variavel email no convite
-- Rode depois da 0011_invite_diagnostics.sql.
...
begin
  ...
  set status = 'canceled'
  where hi.house_id = p_house_id
    and lower(hi.email) = v_email
